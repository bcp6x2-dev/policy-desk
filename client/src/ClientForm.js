...
function ClientForm({ onSave, onClose }) {
  ...
  const s = {
    ...
    modal: { backgroundColor: 'white', borderRadius: '12px', width: '640px', maxHeight: '90vh', overflow: 'hidden', display: 'flex', flexDirection: 'column', boxShadow: '0 8px 30px rgba(0,0,0,0.3)' },
    ...
    tab: (active) => ({ padding: '12px 20px', cursor: 'pointer', fontSize: '13px', fontWeight: active ? '700' : '400', color: active ? GREEN : '#666', borderBottom: active ? `2px solid ${GREEN}` : 'none', backgroundColor: 'transparent', border: 'none', marginBottom: '-2px' }),
    ...
    textarea: { width: '100%', padding: '9px 12px', borderRadius: '6px', border: '1px solid #ddd', fontSize: '14px', boxSizing: 'border-box', minHeight: '100px', resize: 'vertical' },
    sectionTitle: { fontSize: '13px', fontWeight: '700', color: GREEN, textTransform: 'uppercase', marginBottom: '12px', paddingBottom: '6px', borderBottom: `1px solid #E0EDE0` },
