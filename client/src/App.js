  ...
  return (
    <div style={styles.app}>
      <div style={styles.header}>
        ...
        <span style={{ color: '#BDD5F5', fontSize: '14px' }}>Comprehensive Health Solutions</span>
      </div>
        ...
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <form onSubmit={handleAddContact}>
              ...
              <input style={styles.input} placeholder="Date of Birth" type="date" value={newContact.dob} onChange={e => setNewContact({ ...newContact, dob: e.target.value })} />
              ...
              <div style={styles.modalBtns}>
                <button type="button​​​​​​​​​​​​​​​​"
                style={styles.cancelBtn} onClick={() => setShowForm(false)}>Cancel</button>
